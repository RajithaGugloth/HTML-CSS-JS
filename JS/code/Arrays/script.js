...
let res = arr.some((v, i) =>
{
 ...
 let arry= [5,4,6,1,11,14,8,22]
 console.log(arry.sort()) //[1,11,14,22,4,5,6,8]
 arry.sort((a,b)=>a-b) //increasing order
 arry.sort((a, b) => b - a); // reverse order
 console.log(arry)

//reduce
arr = [1, 2, 3, 4, 5];
let resx= arr.reduce((pr, cr) => pr + cr, 0);
console.log(resx)

//flattening array
arr = [[5, 4], [3, 1]] //[5,4,3,1]
let resy=arr.reduce((pr,cr)=>pr.concat(cr),[])
console.log(resy)
